...
| `DATA_REFRESH_INTERVAL_SECONDS` | `backend/app/config.py` | Default 3600 (hourly). Keeps `demand_readings` current for the california region — see `app/services/data_refresh.py` |
